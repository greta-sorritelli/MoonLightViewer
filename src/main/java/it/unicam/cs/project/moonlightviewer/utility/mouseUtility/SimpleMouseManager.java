package it.unicam.cs.project.moonlightviewer.utility.mouseUtility;

import it.unicam.cs.project.moonlightviewer.javaFX.controllers.JavaFXChartController;
...
public class SimpleMouseManager implements MouseManager {
     ...
     */
    protected void mouseButtonClickOnElement(GraphicElement element, MouseEvent event) {
